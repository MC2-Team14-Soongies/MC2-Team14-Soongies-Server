...
public class MemberServiceImpl implements MemberService {
    ...
    @Override
    public MemberResponse.MemberGoogleOauthTokenResponse getGoogleOauthToken(GoogleOauthRequest.GoogleOauthTokenRequest request) {
        GoogleOauthResponse.GoogleOauthTokenResponse googleOauthToken = googleClient.getTokenInfo(request);
